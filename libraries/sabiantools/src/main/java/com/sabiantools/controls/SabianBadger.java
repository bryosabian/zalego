...
/**
 * Created by Brian Sabana on 08/02/2017.
 */
 ...
 */
public final class SabianBadger extends Drawable {
    ...
    public static class Builder {
        ...
        public SabianBadger build() {
            return new SabianBadger(config);
        }
    }

    private SabianBadger(Config config) {
        paint = new Paint();
